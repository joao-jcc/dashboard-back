# Conteúdo movido de src/csv_loader.py
import os
import pandas as pd
import time
import threading
from src.utils.export_data import connect_db, export_events, export_inscricaos, export_transactions, export_event_dynamic_fields
